...
#
# if __name__ == '__main__':
#     Jone = Musition("Jone", "viola")
#     Nicole = Musition("Nicole", "guitar")
#     George = Musition("George", "Drums")
#     Ringo = Musition("Ringo", "Bass")
#     bi2 = Bend("bi2", Jone, Nicole, George, Ringo)
#     for music in bi2.play_music():
#         print(music)
